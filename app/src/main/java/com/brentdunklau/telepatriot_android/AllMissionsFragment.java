...
public class AllMissionsFragment extends Fragment {
    ...
    private TextView header_all_missions;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        myView = inflater.inflate(R.layout.allmissions_fragment, container, false);
        ...
        header_all_missions = myView.findViewById(R.id.header_all_missions);
