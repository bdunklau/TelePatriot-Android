...
exports.downloadApk = functions.https.onRequest((req, res) => {
    ...
    return res.redirect('https://play.google.com/store/apps/details?id=com.brentdunklau.telepatriot_android')
})


//Don't need this anymore now that we are back in the Play Store 3/8/19
